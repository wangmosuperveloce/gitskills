...
public class TSupplementaryHousefund extends org.jooq.impl.TableImpl<jooq.model.tables.records.TSupplementaryHousefundRecord> {
	...
	private static final long serialVersionUID = -2115273000;
	...
	/**
	 * The column <code>oa_salary.t_supplementary_housefund.tenant_id</code>. 公司ID | 王默 | 2016-09-14 | 账号模块
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Long> TENANT_ID = createField("tenant_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "公司ID | 王默 | 2016-09-14 | 账号模块");

	/**
	 * The column <code>oa_salary.t_supplementary_housefund.user_id</code>. 用户ID | 王默 | 2016-09-14 | 账号模块
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Long> USER_ID = createField("user_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "用户ID | 王默 | 2016-09-14 | 账号模块");

	/**
	 * The column <code>oa_salary.t_supplementary_housefund.current_month</code>. 当前时间 | 王默 | 2016-09-14 | 用户界面操作，输入
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Integer> CURRENT_MONTH = createField("current_month", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "当前时间 | 王默 | 2016-09-14 | 用户界面操作，输入");

	/**
	 * The column <code>oa_salary.t_supplementary_housefund.supplementary_pay_month</code>. 补缴的是哪一个月的 | 王默 | 2016-09-14 | 用户界面操作，输入
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Integer> SUPPLEMENTARY_PAY_MONTH = createField("supplementary_pay_month", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "补缴的是哪一个月的 | 王默 | 2016-09-14 | 用户界面操作，输入");

	/**
	 * The column <code>oa_salary.t_supplementary_housefund.company_housefund</code>. 公司公积金补缴金额 | 王默 | 2016-09-14 | 用户界面操作，输入
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Integer> COMPANY_HOUSEFUND = createField("company_housefund", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "公司公积金补缴金额 | 王默 | 2016-09-14 | 用户界面操作，输入");

	/**
	 * The column <code>oa_salary.t_supplementary_housefund.employee_housefund</code>. 个人公积金补缴金额 | 王默 | 2016-09-14 | 用户界面操作，输入
	 */
	public final org.jooq.TableField<jooq.model.tables.records.TSupplementaryHousefundRecord, java.lang.Integer> EMPLOYEE_HOUSEFUND = createField("employee_housefund", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "个人公积金补缴金额 | 王默 | 2016-09-14 | 用户界面操作，输入");
	...
	private TSupplementaryHousefund(java.lang.String alias, org.jooq.Table<jooq.model.tables.records.TSupplementaryHousefundRecord> aliased, org.jooq.Field<?>[] parameters) {
		super(alias, jooq.model.OaSalary.OA_SALARY, aliased, parameters, "薪酬模块 | 公积金补缴表 | 王默 | 2016-09-14 | 社保详情页面，用户界面操作");
	}
	...
	public java.util.List<org.jooq.UniqueKey<jooq.model.tables.records.TSupplementaryHousefundRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<jooq.model.tables.records.TSupplementaryHousefundRecord>>asList(jooq.model.Keys.KEY_T_SUPPLEMENTARY_HOUSEFUND_PRIMARY);
	}
