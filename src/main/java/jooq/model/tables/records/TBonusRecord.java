...
public class TBonusRecord extends org.jooq.impl.UpdatableRecordImpl<jooq.model.tables.records.TBonusRecord> implements org.jooq.Record7<org.jooq.types.ULong, java.lang.Long, java.lang.Long, org.jooq.types.UInteger, java.lang.Long, java.sql.Timestamp, java.sql.Timestamp> {

	private static final long serialVersionUID = 1580491073;
	...
	/**
	 * Setter for <code>oa_salary.t_bonus.tenant_id</code>. 公司ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_bonus.tenant_id</code>. 公司ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_bonus.user_id</code>. 用户ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_bonus.user_id</code>. 用户ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_bonus.bonus_type_id</code>. 奖金类型ID | 邓刚&王默 | 2016-09-14 | t_bonus_type.id
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_bonus.bonus_type_id</code>. 奖金类型ID | 邓刚&王默 | 2016-09-14 | t_bonus_type.id
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_bonus.how_much</code>. 奖金数额 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_bonus.how_much</code>. 奖金数额 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
	 ...
	 */
	@Override
	public org.jooq.Row7<org.jooq.types.ULong, java.lang.Long, java.lang.Long, org.jooq.types.UInteger, java.lang.Long, java.sql.Timestamp, java.sql.Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row7<org.jooq.types.ULong, java.lang.Long, java.lang.Long, org.jooq.types.UInteger, java.lang.Long, java.sql.Timestamp, java.sql.Timestamp> valuesRow() {
	 ...
	 */
	@Override
	public TBonusRecord value5(java.lang.Long value) {
		setHowMuch(value);
		return this;
	}
	 ...
	 */
	@Override
	public TBonusRecord values(org.jooq.types.ULong value1, java.lang.Long value2, java.lang.Long value3, org.jooq.types.UInteger value4, java.lang.Long value5, java.sql.Timestamp value6, java.sql.Timestamp value7) {
		return this;
	}
	 ...
	 */
	public TBonusRecord(org.jooq.types.ULong id, java.lang.Long tenantId, java.lang.Long userId, org.jooq.types.UInteger bonusTypeId, java.lang.Long howMuch, java.sql.Timestamp createTime, java.sql.Timestamp updateTime) {
		super(jooq.model.tables.TBonus.T_BONUS);
