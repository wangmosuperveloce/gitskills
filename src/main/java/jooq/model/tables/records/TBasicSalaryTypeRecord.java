...
public class TBasicSalaryTypeRecord extends org.jooq.impl.UpdatableRecordImpl<jooq.model.tables.records.TBasicSalaryTypeRecord> implements org.jooq.Record8<org.jooq.types.ULong, java.lang.Long, java.lang.String, java.lang.Byte, java.lang.Byte, java.lang.String, java.sql.Timestamp, java.sql.Timestamp> {
	...
	private static final long serialVersionUID = -1281036766;
	...
	/**
	 * Setter for <code>oa_salary.t_basic_salary_type.tenant_id</code>. 公司ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_basic_salary_type.tenant_id</code>. 公司ID | 邓刚&王默 | 2016-09-14 | 账号模块
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_basic_salary_type.salary_name</code>. 该基本工资项的名称 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_basic_salary_type.salary_name</code>. 该基本工资项的名称 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_basic_salary_type.is_participate_overtime</code>. 是否参与计算加班工资 | 邓刚&王默 | 2016-09-14 | @1:参与 @2:不参与 | 用户界面操作，switch按钮
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_basic_salary_type.is_participate_overtime</code>. 是否参与计算加班工资 | 邓刚&王默 | 2016-09-14 | @1:参与 @2:不参与 | 用户界面操作，switch按钮
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_basic_salary_type.is_participate_attendance</code>. 是否参与计算缺勤扣款 | 邓刚&王默 | 2016-09-14 | @1：参与 @2：不参与 | 用户界面操作，switch按钮
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_basic_salary_type.is_participate_attendance</code>. 是否参与计算缺勤扣款 | 邓刚&王默 | 2016-09-14 | @1：参与 @2：不参与 | 用户界面操作，switch按钮
	 */
	...
	/**
	 * Setter for <code>oa_salary.t_basic_salary_type.salary_description</code>. 这项工资的描述 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
	...
	/**
	 * Getter for <code>oa_salary.t_basic_salary_type.salary_description</code>. 这项工资的描述 | 邓刚&王默 | 2016-09-14 | 用户界面操作，输入
	 */
